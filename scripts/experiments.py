...
def main() -> None:
    ...
    (out / "experiments.json").write_text(
        json.dumps(
            {"scenarios": scenarios, "calibration": calibration, "false_positives": false_positives, "bank_marketing": bank},
