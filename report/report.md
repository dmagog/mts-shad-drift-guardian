...
с метриками и p-value. Батч меньше `min_samples` строк (по умолчанию 20) не получает вердикт «ok»
по пропущенным тестам: система выставляет «внимание» и прямо рекомендует накопить данные;
...
**Качество и воспроизводимость:** 86 тестов (движки, качество данных, схема и роли колонок,
