...
def _p_repr(p_value: float) -> str:
    """«p<1e-16» ниже порога печати, иначе «p=0.0023».

    Порог — порядок машинной точности double: сами значения бывают и 1e-201, но
    различать их бессмысленно, а «p=0» было бы неправдой.
    """
